...
import com.example.city.Adapter.CartAdapter
import com.example.city.databinding.ActivityCartBinding
...
class CartActivity : AppCompatActivity() {
    ...
    private fun calculateCart(){
        var percentageTax = 0.02
        val delivery = 10.0
        tax = Math.round((managmentCart.getTotalFee()*percentageTax)*100)/100.0
