...
class ManagmentCart(val context: Context) {
    ...
    fun insertFood(item: RecommendationModel) {
    ...
    fun getListCart(): ArrayList<RecommendationModel> {
        return tinyDB.getListObject("CartList") ?: arrayListOf()
    }

    fun minusItem(listFood: ArrayList<RecommendationModel>, position: Int, listener: ChangeNumberItemsListener) {
    ...
    fun plusItem(listFood: ArrayList<RecommendationModel>, position: Int, listener: ChangeNumberItemsListener) {
        listFood[position].numberInCart++
        tinyDB.putListObject("CartList", listFood)
        listener.onChanged()
    }
