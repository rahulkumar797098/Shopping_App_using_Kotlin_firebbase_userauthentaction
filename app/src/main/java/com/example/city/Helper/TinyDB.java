...
public class TinyDB {
    ...
    public ArrayList<RecommendationModel> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<RecommendationModel> playerList = new ArrayList<RecommendationModel>();

        for (String jObjString : objStrings) {
            RecommendationModel player = gson.fromJson(jObjString, RecommendationModel.class);
    ...
    public void putListObject(String key, ArrayList<RecommendationModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (RecommendationModel player : playerList) {
